...
/// default).
class DateTimeFieldxx extends FormField<DateTime> {
  DateTimeFieldxx({
    ...
    InputCounterWidgetBuilder buildCounter,
            ...
            onSaved: onSaved,
            builder: (field) {
              final _DateTimeFieldxxState state = field;
  ...
  @override
  _DateTimeFieldxxState createState() => _DateTimeFieldxxState();
...
class _DateTimeFieldxxState extends FormFieldState<DateTime> {
  ...
  @override
  DateTimeFieldxx get widget => super.widget;
  ...
  @override
  void didUpdateWidget(DateTimeFieldxx oldWidget) {
  ...
  String format(DateTime date) => DateTimeFieldxx.tryFormat(date, widget.format);
  DateTime parse(String text) => DateTimeFieldxx.tryParse(text, widget.format);
